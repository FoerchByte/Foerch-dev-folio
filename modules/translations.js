...
export const translations = {
    pl: {
        ...
        roiYearlyCostTitle: "Roczny koszt ręcznej pracy",
        roiCopyReport: "Kopiuj Raport",
        roiWastedBadge: "// PRZEPALONE NA POWTARZALNE ZADANIA",
        roiTeamParamsTitle: "Parametry Zespołu",
        roiHoursLabel: "Czas na ręczne zadania (h/tydz)",
        roiRateLabel: "Stawka godzinowa (PLN)",
        roiTeamLabel: "Liczba pracowników",
        roiForecastTitle: "Prognoza strat 5-letnia",
        roiYear1: "ROK 1",
        roiYear3: "ROK 3",
        roiYear5: "ROK 5",
        roiAccumulatedLoss: "Skumulowana strata:",
        roiSolutionTitle: "// ROZWIĄZANIE_PROBLEMU",
        roiSolutionDesc: "Skrypt Python / GAS kosztuje ułamek tej kwoty, pracuje 24/7 i zwraca się średnio w 2 tygodnie.",
        roiOrderBtn: "Zleć Automatyzację",
        roiToastCopied: "Raport skopiowany!",
        roiReportTitle: "ANALIZA KOSZTÓW BRAKU AUTOMATYZACJI",
        roiReportTeamSize: "Wielkość zespołu:",
        roiReportHours: "Czas na ręczne zadania:",
        roiReportRate: "Średnia stawka brutto:",
        roiReportYearly: "Roczny koszt operacyjny:",
        roiReportFiveYear: "Prognozowana strata (5 lat):",
        roiReportGeneratedBy: "Wygenerowano przez: Kalkulator ROI Automatyzacji",
        roiEmailSubject: "Zapytanie o automatyzację procesów - Zespół",
        roiEmailBody1: "Dzień dobry,\n\nSkorzystałem z Kalkulatora ROI. Obecnie nasz zespół (",
        roiEmailBody2: " os.) spędza około ",
        roiEmailBody3: " godzin tygodniowo na powtarzalnych zadaniach w Excelu/systemach.\n\nKalkulator wskazał roczny koszt tej pracy na poziomie ",
        roiEmailBody4: " PLN.\n\nChciałbym porozmawiać o możliwości zautomatyzowania tych procesów przy użyciu skryptu Python lub Google Apps Script.\n\nPozdrawiam,",
        roiToastFailed: "Nie udało się skopiować raportu.",
    ...
    en: {
        ...
        roiYearlyCostTitle: "Annual Cost of Manual Work",
        roiCopyReport: "Copy Report",
        roiWastedBadge: "// WASTED ON REPETITIVE TASKS",
        roiTeamParamsTitle: "Team Parameters",
        roiHoursLabel: "Time spent on manual tasks (h/week)",
        roiRateLabel: "Hourly rate (PLN)",
        roiTeamLabel: "Number of employees",
        roiForecastTitle: "5-Year Loss Forecast",
        roiYear1: "YEAR 1",
        roiYear3: "YEAR 3",
        roiYear5: "YEAR 5",
        roiAccumulatedLoss: "Accumulated loss:",
        roiSolutionTitle: "// PROBLEM_SOLUTION",
        roiSolutionDesc: "A Python / GAS script costs a fraction of this amount, works 24/7, and pays for itself in an average of 2 weeks.",
        roiOrderBtn: "Order Automation",
        roiToastCopied: "Report copied!",
        roiReportTitle: "COST ANALYSIS OF LACK OF AUTOMATION",
        roiReportTeamSize: "Team size:",
        roiReportHours: "Time for manual tasks:",
        roiReportRate: "Average gross rate:",
        roiReportYearly: "Annual operational cost:",
        roiReportFiveYear: "Projected loss (5 years):",
        roiReportGeneratedBy: "Generated by: Automation ROI Calculator",
        roiEmailSubject: "Inquiry about process automation - Team of",
        roiEmailBody1: "Hello,\n\nI used the ROI Calculator. Currently, our team (",
        roiEmailBody2: " people) spends about ",
        roiEmailBody3: " hours per week on repetitive tasks in Excel/systems.\n\nThe calculator indicated the annual cost of this work at ",
        roiEmailBody4: " PLN.\n\nI would like to discuss the possibility of automating these processes using a Python or Google Apps Script.\n\nBest regards,",
        roiToastFailed: "Failed to copy the report.",
